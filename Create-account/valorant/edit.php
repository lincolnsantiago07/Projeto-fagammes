...
if(!empty($_GET['id'])){
    ...
    $sqlSelect = "SELECT * FROM valorant WHERE id=$id";
...
<head>
    ...
    <link rel="stylesheet" href="../../Team-Valorant/style.css">
    <link rel="stylesheet" href="../../Team-Valorant/variables.css">
...
<body>
            ...
            <div class="details ID">
                <div class="details family">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            <label>Qual o maior elo do time?</label>
                            <input type="text" name="maior_elo" placeholder="maior elo do time" value="<?php echo $maiorelo ?>" >
                        </div>
    ...
    <script src="../../Team-Valorant/scrollreveal.js"></script>
    <script src="../../Team-Valorant/script.js"></script>
</body>
</html>