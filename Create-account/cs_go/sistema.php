<?php
    ...
    if(!empty($_GET['search'])){
        $data = $_GET['search'];
        $sql = "SELECT * FROM cs WHERE id LIKE '%$data%' or nick1 LIKE '%$data%' or nick2 LIKE '%$data%' or nick3 LIKE '%$data%' or nick4 LIKE '%$data%' 
        or nick5 LIKE '%$data%' or maior_elo LIKE '%$data%'  ORDER BY id DESC";
    }
    else{
        $sql = "SELECT * FROM cs ORDER BY id DESC";
    }
...
<body>
    ...
    <?php
        ...
        echo "<h2>Este é o banco de dados do CS:GO ;)</h2>";
    ?>
    <br>
